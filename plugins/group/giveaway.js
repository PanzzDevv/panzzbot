...
function getGiveawayImage() {
    ...
    const defaultPath = path.join(process.cwd(), 'assets', 'images', 'Panzz.jpg')
    ...
    if (action === 'start' || action === 'create' || action === 'new') {
        ...
        try {
            ...
            try {
                ...
                try {
                    thumbnail = fs.readFileSync('./assets/images/Panzz.jpg')
                } catch (e2) {}
            }
            ...
            await sock.sendMessage(m.chat, {
                ...
                contextInfo: {
                    ...
                    externalAdReply: thumbnail ? {
                        title: botConfig.bot?.name || 'Panzz MD',
                ...
                footer: botConfig.bot?.name || 'Panzz MD',
                interactiveButtons: [
                    {
                        name: 'single_select',
