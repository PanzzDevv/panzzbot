...
async function handler(m, { sock, config: botConfig, db, uptime }) {
    ...
    infoText += `│  ◦ \`Nama\`: ${botConfig.bot?.name || 'Panzz-AI'}\n`;
    infoText += `│  ◦ \`Versi\`: ${botConfig.bot?.version || '1.0.0'}\n`;
    infoText += `│  ◦ \`Developer\`: ${botConfig.bot?.developer || 'Panzz Team'}\n`;
    ...
    const contextInfo = {
        ...
        externalAdReply: {
            ...
            thumbnail: fs.existsSync('./assets/images/Panzz.jpg') ? fs.readFileSync('./assets/images/Panzz.jpg') : undefined,
