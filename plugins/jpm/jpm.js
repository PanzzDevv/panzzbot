...
try {
    if (fs.existsSync('./assets/images/Panzz2.jpg')) {
        cachedThumb = fs.readFileSync('./assets/images/Panzz2.jpg')
    }
} catch (e) {}
...
async function handler(m, { sock }) {
    ...
    try {
        ...
        const contextInfo = getContextInfo('📢 ᴊᴘᴍ', config.bot?.name || 'Panzz')
