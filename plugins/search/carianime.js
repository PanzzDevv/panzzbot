...
async function handler(m, { sock }) {
    ...
    try {
        ...
        const imagePath = path.join(process.cwd(), 'assets', 'images', 'Panzz-v8.jpg')
        ...
        await sock.interactiveButtons(m.chat, {
            image: imageBuffer,
            caption: caption,
            footer: `${config.bot?.name || 'Panzz-AI'} • Anime Search`,
            buttons: [{
                name: 'single_select',
    ...
    try {
        ...
        if (episodes.length > 0) {
            ...
            await sock.interactiveButtons(m.chat, {
                ...
                caption: caption,
                footer: `${config.bot?.name || 'Panzz-AI'} • Anime Detail`,
                buttons: [{
                    name: 'single_select',
                    buttonParamsJson: JSON.stringify({
                        title: '📺 Pilih Episode',
