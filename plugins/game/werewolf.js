...
try {
    ...
    if (fs.existsSync(path.join(assetsPath, 'Panzz-games.jpg'))) {
        thumbWW = fs.readFileSync(path.join(assetsPath, 'Panzz-games.jpg'))
    }
    if (fs.existsSync(path.join(assetsPath, 'Panzz.jpg'))) {
        thumbNight = fs.readFileSync(path.join(assetsPath, 'Panzz.jpg'))
        thumbDay = fs.readFileSync(path.join(assetsPath, 'Panzz.jpg'))
    }
    if (fs.existsSync(path.join(assetsPath, 'Panzz-winner.jpg'))) {
        thumbWin = fs.readFileSync(path.join(assetsPath, 'Panzz-winner.jpg'))
    }
} catch (e) {
