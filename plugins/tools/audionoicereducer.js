...
const { downloadMediaMessage } = require('Panzz')
const path = require('path')
const fs = require('fs')

const NEOXR_APIKEY = config.APIkey?.neoxr || 'Milik-Bot-PanzzMD'
...
let thumbTools = null
try {
    const p = path.join(process.cwd(), 'assets/images/Panzz-tools.jpg')
